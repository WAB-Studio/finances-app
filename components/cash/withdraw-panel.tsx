...
/**
 * The desktop dashboard's cash card (RF-68): the withdrawal in place, with no
 * dialog between the person and the move. It runs `withdrawCashAction` behind
 * `withdrawCashSchema`, the same pair the phone's dialog submits through, so the
 * server rejects exactly what this rejects (RNF-10).
 *
